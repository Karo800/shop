...
if(isset($_POST['submit']) && $_SERVER['REQUEST_METHOD'] === 'POST'){
  ...
  // $_FILES est une superglobale permettant de stocker les données d'un fichier uploadé (nom, extension, taille etc...)
  ...
  if(!empty($_FILES['picture']['name'])){
    ...
    // SplFileInfo : classe prédéfinit en PHP permettant de traiter les données d'un fichier uploadé, elle contient ses propres méthodes (fonction)
    ...
    // array_search() : fonction prédéfinie qui retourne la position d'unélément (indice) dans un tableau Array
    ...
    // Si array_search retourne false, cela veut dire que l'extension n'a pas été trouvée dans le tableau Array $currentExtension, alors on entre dans le IF.
    ...
    // "http://localhost/PHP gg/shop/assets/images-produits/25A45C-p7.png"
    ...
    // /opt/xampp/htdocs/PHP/shop/assets/images-produis/25A45C-p7.png
...
?>
    ...
    <section class="section is-main-section">
      <div class="card">
        ...
        <div class="card-content">
          <!-- enctype="multipart/form-data" : permet de récupérer en php les données d'un fichier uploadé -->
          <form method="post" enctype="multipart/form-data">
                  ...
                  <div class="control">
                    <div class="select is-fullwidth">
                      <select name="size">
                        ...
                        <option value="M" <?php if(isset($currentProductr['size']) && $currentProduct['size'] == 'M') echo 'selected' ?>>M</option>

                        <option value="L" <?php if(isset($currentProductr['size']) && $currentProduct['size'] == 'L') echo 'selected' ?>>L</option>

                        <option value="XL" <?php if(isset($currentProductr['size']) && $currentProduct['size'] == 'XL') echo 'selected' ?>>XL</option>
                      </select>
                    </div>
                  </div>
                </div>
            ...
            <div class="field is-horizontal">
              ...
              <div class="field-body">
                ...
                <div class="field">
                  <input class="input" type="text" name="stock" placeholder="Entrer une stock produit" value="<?php if(isset($currentProduct['stock'])) echo $currentProduct['stock'] ?>" />
                </div>
              </div>
            </div>
